...
export function getDummyMessages (): Message[] {
  return [
    {id: "1", createdAt: new Date(), content: "Hello", sender: "Enzo"},
    {id: "2", createdAt: new Date(), content: "How are you?", sender: "Enzo"},
    {id: "3", createdAt: new Date(), content: "I'm fine, thanks!", sender: "John"},
